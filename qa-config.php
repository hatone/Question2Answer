...
*/
	...
	define('QA_MYSQL_HOSTNAME', 'DUMMY_DB_HOST'); // try '127.0.0.1' or 'localhost' if MySQL on same server
	define('QA_MYSQL_USERNAME', 'DUMMY_PROJECT_NAME');
	define('QA_MYSQL_PASSWORD', 'DUMMY_DB_PASSWORD');
	define('QA_MYSQL_DATABASE', 'DUMMY_PROJECT_NAME');
